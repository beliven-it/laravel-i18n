        ...
        foreach (array_keys($foundKeys) as $key) {
            ...
            foreach ($locales as $locale) {
                if ($parsed["type"] === "json") {
                    ...
                    $fileExists = $translationFileManager->jsonFileExists(
                        $locale,
                    );
                    $keyExists = $translationFileManager->jsonKeyExists(
                        $locale,
                        $parsed["key"],
                    );
                    ...
                    if (!$keyExists) {
                        $translationFileManager->addJsonKey(
                            $locale,
                            $parsed["key"],
                        );
                        $stats["keys_added"]++;
